...
const CREATORS: Creator[] = [
  {
    ...
    avatar: '', coverGradient: 'from-emerald-800 to-teal-950',
  ...
  },
  {
    ...
    avatar: '', coverGradient: 'from-pink-800 to-rose-950',
  ...
  },
  {
    ...
    avatar: '', coverGradient: 'from-violet-800 to-indigo-950',
  ...
  },
  {
    ...
    avatar: '', coverGradient: 'from-blue-800 to-cyan-950',
  ...
  },
  {
    ...
    avatar: '', coverGradient: 'from-amber-800 to-orange-950',
  ...
  },
  {
    ...
    avatar: '', coverGradient: 'from-fuchsia-800 to-purple-950',
  ...
  },
  {
    ...
    avatar: '', coverGradient: 'from-slate-800 to-zinc-950',
  ...
  },
  {
    ...
    avatar: '', coverGradient: 'from-yellow-800 to-red-950',
  ...
  },
  {
    ...
    avatar: '', coverGradient: 'from-sky-800 to-blue-950',
  ...
  },
  {
    ...
    avatar: '', coverGradient: 'from-stone-800 to-neutral-950',
  ...
  },
  {
    ...
    avatar: '', coverGradient: 'from-amber-900 to-yellow-950',
  ...
  },
  {
    ...
    avatar: '', coverGradient: 'from-gray-900 to-black',
...
const FILMS: FeedFilm[] = [
  {
    ...
    genre: 'Documentary',
    style: 'Realistic',
    thumbnail: '/landing/showcase-dino-hatch.webp',
  ...
  },
  {
    ...
    genre: 'Kids & Family',
    style: 'Pixar',
    thumbnail: '/landing/idea-children-pixar.webp',
  ...
  },
  {
    ...
    genre: 'Sci-Fi',
    style: 'Cyberpunk',
    thumbnail: '/landing/style-cyberpunk.webp',
  ...
  },
  {
    ...
    genre: 'Documentary',
    style: 'Realistic',
    thumbnail: '/landing/showcase-underwater.webp',
  ...
  },
  {
    ...
    genre: 'Food & Culture',
    style: 'Realistic',
    thumbnail: '/landing/idea-cooking.webp',
  ...
  },
  {
    ...
    genre: 'Music Video',
    style: 'Experimental',
    thumbnail: '/landing/idea-music.webp',
  ...
  },
  {
    ...
    genre: 'Education',
    style: 'Realistic',
    thumbnail: '/landing/showcase-space.webp',
  ...
  },
  {
    ...
    genre: 'Adventure',
    style: 'Realistic',
    thumbnail: '/landing/showcase-pirate.webp',
  ...
  },
  {
    ...
    genre: 'Kids & Family',
    style: 'Pixar',
    thumbnail: '/landing/style-pixar.webp',
  ...
  },
  {
    ...
    genre: 'Drama',
    style: 'Hand-drawn',
    thumbnail: '/landing/showcase-samurai.webp',
  ...
  },
  {
    ...
    genre: 'Commercial',
    style: 'Realistic',
    thumbnail: '/landing/idea-advertising.webp',
  ...
  },
  {
    ...
    genre: 'Fantasy',
    style: 'Cinematic',
    thumbnail: '/landing/idea-travel.webp',
  ...
  },
  {
    ...
    genre: 'Horror',
    style: 'Realistic',
    thumbnail: '/landing/style-realistic.webp',
  ...
  },
  {
    ...
    genre: 'Animation',
    style: 'Comic Book',
    thumbnail: '/landing/style-comic.webp',
  ...
  },
  {
    ...
    genre: 'Kids & Family',
    style: 'LEGO',
    thumbnail: '/landing/style-lego.webp',
...
const CreatorAvatar = ({ creator, size = 'sm' }: { creator: Creator; size?: 'sm' | 'md' | 'lg' }) => {
  ...
  return (
    <div className="relative shrink-0">
      <div className={`${sizes[size]} rounded-full bg-gradient-to-br ${colors[colorIndex]} flex items-center justify-center text-white font-bold ring-2 ring-[#07070e]`}>
